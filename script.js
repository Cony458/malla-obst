const ramos = [
  ...
  { nombre: "Integrador II: Practica de matronería en la comunidad", requisitos: ["Educación con enfoque curso de vida", "Matronería patológica integrada y gestión", "Metodología de la investigación", "Sexología, género y derecho", "Intervención en contextos sociales y comunitarios", "Matronería legal y bioética"] },
  { nombre: "Imagenología en matronería", requisitos: ["Educación con enfoque curso de vida", "Matronería patológica integrada y gestión", "Metodología de la investigación", "Sexología, género y derecho", "Intervención en contextos sociales y comunitarios", "Matronería legal y bioética"] },
  { nombre: "Matronería oncológica y reproducción asistida", requisitos: ["Educación con enfoque curso de vida", "Matronería patológica integrada y gestión", "Metodología de la investigación", "Sexología, género y derecho", "Intervención en contextos sociales y comunitarios", "Matronería legal y bioética"] },
  { nombre: "Proyecto de Matronería", requisitos: ["Metodología de la investigación"] },

  // --- QUINTO AÑO ---
  { nombre: "Habilitación profesional I", requisitos: ["Integrador II: Practica de matronería en la comunidad", "Imagenología en matronería", "Matronería oncológica y reproducción asistida", "Proyecto de Matronería"] },
  { nombre: "Habilitación profesional II", requisitos: ["Integrador II: Practica de matronería en la comunidad", "Imagenología en matronería", "Matronería oncológica y reproducción asistida", "Proyecto de Matronería"] }
];
